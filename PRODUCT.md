...
## Stack
React, Vite e Three.js. A conversa aceitou a proposta de editor visual com controles à esquerda e prévia à direita, seguido de chat. GitHub Pages é o destino da primeira versão; nenhuma chave de IA é necessária nesta versão.

## Users
Pessoas da comunidade INEMA que querem personalizar e publicar um site sem editar a cena 3D. Desenvolvedores podem reutilizar o código. Prioridade inicial: profissionais, agências e autores.

## Product Purpose
Escolher um modelo testado, inserir conteúdo próprio, ver a prévia e exportar um site utilizável. Interface e futuro chat compartilham uma configuração validada e histórico de alterações.
...
## Product Principles
- Conteúdo útil disponível mesmo sem WebGL.
- Personalização previsível, sem gerar novos assets a cada edição.
- Portabilidade: a pessoa mantém uma cópia do site e da configuração.
- Distinguir recursos disponíveis de versões futuras.
